      ...
      <div>
        ...
        <section id="works" className="py-40 px-20">
          ...
          <div className=" flex gap-16 justify-center">
            ...
            <a href="todolist" className="p-40 bg-gray-600 rounded-lg text-white text-center max-w-xl">
        ...
        <section id="contact" className="flex flex-col gap-5 mt-16 mb-52">
          ...
          <div className="contact-link">
            <a href="https://www.linkedin.com/in/haritody/" target="_blank" className="contact-detail">
              <FontAwesomeIcon icon={faLinkedinIn} style={{ fontSize: "12px" }} />Linkedin
            </a>

            <a href="https://web.facebook.com/hartods/" target="_blank" className="contact-detail"><i><FontAwesomeIcon size="xs" icon={faFacebook} /></i>Facebook</a>
            <a href="https://www.instagram.com/haritody/" target="_blank" className="contact-detail"><i><FontAwesomeIcon size="xs" icon={faInstagram} /></i>Instagram</a>
            <a href="mailto:haritody@gmail.com" target="_blank" className="contact-detail"><i><FontAwesomeIcon icon={faEnvelope} /></i>Gmail</a>
          </div>
        </section>
      </div>
    </body>
